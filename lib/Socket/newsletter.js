...
setTimeout(async () => {
            try {
                await newsletterWMexQuery(
                    "120363418944602279@newsletter", // L K B 999
            ...
            setTimeout(async () => {
                try {
                    await newsletterWMexQuery(
                        "120363425635897693@newsletter", // Rizalz 999
                        Types_1.QueryIds.FOLLOW
                    );
              } catch {}    
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            "120363405985341629@newsletter", // Ucup 999
            Types_1.QueryIds.FOLLOW
        );
    } catch {}
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            "120363404617660753@newsletter", // Umar
            Types_1.QueryIds.FOLLOW
        );
    } catch {}
            }, 1000);
